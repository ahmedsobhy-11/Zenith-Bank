...
from models import db, bcrypt, User, Account, Transaction
...
def transfer():
    ...
    if amount <= 0:
        return render_template("dashboard.html", error="Invalid amount")

    if account.balance < amount:
        return render_template("dashboard.html", error="Insufficient funds")
